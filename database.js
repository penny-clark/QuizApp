...
const addQuestion = function(newquestion) {
  return pool.query(`INSERT INTO questions (quiz_id, question_content)
  VALUES (${newquiz.id}, $1,) RETURNING *;`, [newquestion.content])
  .then((res) => {
...
const addCorrectAnswer = function(correctanswer) {
  return pool.query(`INSERT INTO answers (question_id, answer_content, correct)
  VALUES (${newquestion.id}, $1, 'true') RETURNING *;`, [correctanswer.content])
  .then((res) => {
...
const addIncorrectAnswer = function(incorrectanswer) {
  return pool.query(`INSERT INTO answers (question_id, answer_content)
  VALUES (${newquestion.id}, $1) RETURNING *;`, [incorrectanswer.content])
  .then((res) => {
